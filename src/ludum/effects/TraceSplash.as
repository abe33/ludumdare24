package ludum.effects
{
     ...
     * @author cedric
     */
    public class TraceSplash extends Sprite implements Allocable, ImpulseListener
    {
        ...
        public function TraceSplash (bitmap: BitmapData)
        {
            init();
            _bitmap = bitmap;
        }
        ...
        public function init () : void
        {
            ...
            spriteSplash.copyPixels(spritesheet.bitmapData, rect(RandomUtils.irandom(w-1)*Constants.SPLATS_WIDTH, Constants.SPLATS_HEIGHT*3, Constants.SPLATS_WIDTH, Constants.SPLATS_HEIGHT), pt());
                        
            splashBmp = new Bitmap(spriteSplash, 'auto', true);
            
            splashSprite = new Sprite();
            splashBmp.rotation = 180;
        ...
        public function tick ( bias : Number, biasInSeconds : Number, currentTime : Number ) : void
        {
            ...
            if( _t < 100 )
            {
                splashSprite.scaleX = splashSprite.scaleY = 0.1 + ((_t/100) * (_t/100))*0.5;             
            }
            if( _t > 125 )
            {
